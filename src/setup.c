/* setup.c generated by valac 0.24.0, the Vala compiler
...
static void __lambda5_ (Setup* self);
...
static void ___lambda9__gtk_spin_button_value_changed (GtkSpinButton* _sender, gpointer self);
...
static void _setup_accel_edited_gtk_cell_renderer_accel_accel_edited (GtkCellRendererAccel* _sender, const gchar* path_string, guint accel_key, GdkModifierType accel_mods, guint hardware_keycode, gpointer self) {
	setup_accel_edited ((Setup*) self, path_string, accel_key, accel_mods, hardware_keycode);
}


static void _setup_accel_cleared_gtk_cell_renderer_accel_accel_cleared (GtkCellRendererAccel* _sender, const gchar* path_string, gpointer self) {
	setup_accel_cleared ((Setup*) self, path_string);
}
...
static void _setup_add_shortcut_gtk_tool_button_clicked (GtkToolButton* _sender, gpointer self) {
	setup_add_shortcut ((Setup*) self);
}


static void _setup_remove_shortcut_gtk_tool_button_clicked (GtkToolButton* _sender, gpointer self) {
	setup_remove_shortcut ((Setup*) self);
}
...
static void ___lambda5__gtk_toggle_button_toggled (GtkToggleButton* _sender, gpointer self) {
	__lambda5_ ((Setup*) self);
}


static void _setup_add_dict_gtk_tool_button_clicked (GtkToolButton* _sender, gpointer self) {
	setup_add_dict ((Setup*) self);
}


static void _setup_remove_dict_gtk_tool_button_clicked (GtkToolButton* _sender, gpointer self) {
	setup_remove_dict ((Setup*) self);
}


static void _setup_up_dict_gtk_tool_button_clicked (GtkToolButton* _sender, gpointer self) {
	setup_up_dict ((Setup*) self);
}


static void _setup_down_dict_gtk_tool_button_clicked (GtkToolButton* _sender, gpointer self) {
	setup_down_dict ((Setup*) self);
}
...
Setup* setup_construct (GType object_type, Preferences* preferences) {
	...
	GtkToolButton* add_dict_toolbutton = NULL;
	GObject* _tmp67_ = NULL;
	GtkToolButton* _tmp68_ = NULL;
	...
	SetupDictCellRenderer* _tmp126_ = NULL;
	GtkCellRenderer* _tmp127_ = NULL;
	GtkTreeViewColumn* _tmp128_ = NULL;
	GtkTreeView* _tmp129_ = NULL;
	GtkTreeViewColumn* _tmp130_ = NULL;
	GtkListStore* _tmp131_ = NULL;
	GtkTreeView* _tmp132_ = NULL;
	GtkListStore* _tmp133_ = NULL;
	SetupDictCellRenderer* _tmp134_ = NULL;
	GtkCellRenderer* _tmp135_ = NULL;
	GtkTreeViewColumn* _tmp136_ = NULL;
	GtkTreeView* _tmp137_ = NULL;
	GtkTreeViewColumn* _tmp138_ = NULL;
	GtkCellRendererText* _tmp139_ = NULL;
	GtkComboBox* _tmp140_ = NULL;
	GtkCellRenderer* _tmp141_ = NULL;
	GtkComboBox* _tmp142_ = NULL;
	GtkCellRenderer* _tmp143_ = NULL;
	GtkCellRendererText* _tmp144_ = NULL;
	GtkComboBox* _tmp145_ = NULL;
	GtkCellRenderer* _tmp146_ = NULL;
	GtkComboBox* _tmp147_ = NULL;
	GtkCellRenderer* _tmp148_ = NULL;
	GtkCellRendererText* _tmp149_ = NULL;
	GtkCellRenderer* _tmp150_ = NULL;
	GtkTreeViewColumn* _tmp151_ = NULL;
	GtkTreeView* _tmp152_ = NULL;
	GtkTreeViewColumn* _tmp153_ = NULL;
	GtkTreeView* _tmp154_ = NULL;
	GtkTreeSelection* _tmp155_ = NULL;
	GtkTreeSelection* _tmp156_ = NULL;
	GtkTreeSelection* _tmp157_ = NULL;
	GtkListStore* _tmp158_ = NULL;
	GtkListStore* _tmp159_ = NULL;
	GtkTreeView* _tmp160_ = NULL;
	GtkListStore* _tmp161_ = NULL;
	GtkCellRendererText* _tmp162_ = NULL;
	GtkCellRenderer* _tmp163_ = NULL;
	GtkTreeViewColumn* _tmp164_ = NULL;
	GtkTreeView* _tmp165_ = NULL;
	GtkTreeViewColumn* _tmp166_ = NULL;
	SetupKeyEventCellRenderer* accel_renderer = NULL;
	SetupKeyEventCellRenderer* _tmp167_ = NULL;
	SetupKeyEventCellRenderer* _tmp168_ = NULL;
	SetupKeyEventCellRenderer* _tmp169_ = NULL;
	GtkTreeViewColumn* _tmp170_ = NULL;
	GtkTreeView* _tmp171_ = NULL;
	GtkTreeViewColumn* _tmp172_ = NULL;
	SetupKeyEventCellRenderer* _tmp173_ = NULL;
	SetupKeyEventCellRenderer* _tmp174_ = NULL;
	GtkTreeView* _tmp175_ = NULL;
	GtkTreeSelection* _tmp176_ = NULL;
	GtkTreeSelection* _tmp177_ = NULL;
	GtkTreeSelection* _tmp178_ = NULL;
	GtkListStore* _tmp179_ = NULL;
	GtkListStore* _tmp180_ = NULL;
	GtkComboBox* _tmp181_ = NULL;
	GtkListStore* _tmp182_ = NULL;
	gchar** commands = NULL;
	gint _tmp183_ = 0;
	gchar** _tmp184_ = NULL;
	...
	GtkCellRendererText* _tmp196_ = NULL;
	GtkComboBox* _tmp197_ = NULL;
	GtkCellRenderer* _tmp198_ = NULL;
	GtkComboBox* _tmp199_ = NULL;
	GtkCellRenderer* _tmp200_ = NULL;
	GtkToolButton* _tmp201_ = NULL;
	GtkToolButton* _tmp202_ = NULL;
	GtkListStore* _tmp203_ = NULL;
	GtkListStore* _tmp204_ = NULL;
	GtkComboBox* _tmp205_ = NULL;
	GtkListStore* _tmp206_ = NULL;
	KkcRuleMetadata** rules = NULL;
	gint _tmp207_ = 0;
	KkcRuleMetadata** _tmp208_ = NULL;
	gint rules_length1 = 0;
	gint _rules_size_ = 0;
	KkcRuleMetadata** _tmp209_ = NULL;
	gint _tmp209__length1 = 0;
	GtkCellRendererText* _tmp224_ = NULL;
	GtkComboBox* _tmp225_ = NULL;
	GtkCellRenderer* _tmp226_ = NULL;
	GtkComboBox* _tmp227_ = NULL;
	GtkCellRenderer* _tmp228_ = NULL;
	GtkCellRendererText* _tmp229_ = NULL;
	GtkComboBox* _tmp230_ = NULL;
	GtkCellRenderer* _tmp231_ = NULL;
	GtkComboBox* _tmp232_ = NULL;
	GtkCellRenderer* _tmp233_ = NULL;
	GtkCheckButton* _tmp234_ = NULL;
	GtkToolButton* _tmp235_ = NULL;
	GtkToolButton* _tmp236_ = NULL;
	GtkToolButton* _tmp237_ = NULL;
	GtkToolButton* _tmp238_ = NULL;
	GtkTreeView* _tmp239_ = NULL;
	GtkTreeSelection* _tmp240_ = NULL;
	GtkTreeSelection* _tmp241_ = NULL;
	...
	g_signal_connect_data (_tmp157_, "changed", (GCallback) ___lambda3__gtk_tree_selection_changed, block1_data_ref (_data1_), (GClosureNotify) block1_data_unref, 0);
	...
	g_signal_connect_data (_tmp178_, "changed", (GCallback) ___lambda4__gtk_tree_selection_changed, block1_data_ref (_data1_), (GClosureNotify) block1_data_unref, 0);
	...
	_tmp209__length1 = rules_length1;
	{
		...
		for (rule_it = 0; rule_it < _tmp209__length1; rule_it = rule_it + 1) {
			...
			rule = _tmp210_;
			{
				...
				if (_tmp213_ > 70) {
					GtkTreeIter iter = {0};
					GtkListStore* _tmp214_ = NULL;
					GtkTreeIter _tmp215_ = {0};
					GtkListStore* _tmp216_ = NULL;
					GtkTreeIter _tmp217_ = {0};
					KkcRuleMetadata* _tmp218_ = NULL;
					const gchar* _tmp219_ = NULL;
					const gchar* _tmp220_ = NULL;
					KkcRuleMetadata* _tmp221_ = NULL;
	...
	g_signal_connect_object ((GtkToggleButton*) _tmp234_, "toggled", (GCallback) ___lambda5__gtk_toggle_button_toggled, self, 0);
	setup_load (self);
	...
	g_signal_connect_data (_data1_->dictionaries_selection, "changed", (GCallback) ___lambda10__gtk_tree_selection_changed, block1_data_ref (_data1_), (GClosureNotify) block1_data_unref, 0);
...
static void setup_accel_edited (Setup* self, const gchar* path_string, guint keyval, GdkModifierType modifiers, guint keycode) {
	...
	if (_tmp6_) {
		...
		if (_tmp17_ != NULL) {
			...
			KkcKeyEvent* _tmp34_ = NULL;
			KkcKeymap* _tmp37_ = NULL;
			...
			{
				KkcUserRule* _tmp40_ = NULL;
				KkcInputMode _tmp41_ = 0;
...
static void setup_add_shortcut (Setup* self) {
	...
	if (_tmp1_ == ((gint) GTK_RESPONSE_OK)) {
		...
		_tmp11_ = command;
		_tmp12_ = command;
		_tmp13_ = kkc_keymap_get_command_label (_tmp12_);
		_tmp14_ = _tmp13_;
		gtk_list_store_set (_tmp9_, &_tmp10_, 0, _tmp11_, 1, NULL, 2, _tmp14_, -1, -1);
		_g_free0 (_tmp14_);
		_g_object_unref0 (model);
		_g_free0 (command);
	}
	_tmp15_ = self->priv->shortcut_dialog;
...
static void setup_remove_shortcut (Setup* self) {
				...
				if (_tmp15_) {
					...
					if (_tmp18_ != NULL) {
						...
						if (_tmp22_ == 0) {
							...
							_tmp25_ = _tmp24_;
							_tmp19_ = _vala_uint_array_contains (SETUP_IGNORED_KEYVALS, G_N_ELEMENTS (SETUP_IGNORED_KEYVALS), _tmp25_);
						} else {
							_tmp19_ = FALSE;
						}
						if (_tmp19_) {
	...
	__catch3_g_error:
	{
		...
		g_warning ("setup.vala:438: can't write shortcut: %s", _tmp33_);
		_g_error_free0 (e);
	}
	__finally3:
	if (_inner_error_ != NULL) {
...
static void setup_populate_shortcut_treeview (Setup* self, KkcInputMode input_mode) {
	...
	__catch4_g_error:
	{
		...
		_tmp10_ = e->message;
		g_error ("setup.vala:497: can't load typing rule %s: %s", _tmp9_, _tmp10_);
		_g_error_free0 (e);
	}
	__finally4:
	if (_inner_error_ != NULL) {
...
static void setup_load_spinbutton (Setup* self, const gchar* name, GtkSpinButton* spin) {
	...
	_tmp9_ = _data2_->spin;
	g_signal_connect_data (_tmp9_, "value-changed", (GCallback) ___lambda9__gtk_spin_button_value_changed, block2_data_ref (_data2_), (GClosureNotify) block2_data_unref, 0);
	_g_variant_unref0 (variant);
...
static void setup_load_togglebutton (Setup* self, const gchar* name, GtkToggleButton* toggle) {
	...
	g_signal_connect_data (_tmp9_, "toggled", (GCallback) ___lambda8__gtk_toggle_button_toggled, block3_data_ref (_data3_), (GClosureNotify) block3_data_unref, 0);
	_g_variant_unref0 (variant);
...
static void setup_load_combobox (Setup* self, const gchar* name, GtkComboBox* combo, gint column) {
	...
	g_signal_connect_data (_tmp27_, "changed", (GCallback) ___lambda7__gtk_combo_box_changed, block4_data_ref (_data4_), (GClosureNotify) block4_data_unref, 0);
	_g_object_unref0 (model);
	_g_variant_unref0 (variant);
...
static void setup_load_combobox_string (Setup* self, const gchar* name, GtkComboBox* combo, gint column) {
	...
	g_signal_connect_data (_tmp28_, "changed", (GCallback) ___lambda6__gtk_combo_box_changed, block5_data_ref (_data5_), (GClosureNotify) block5_data_unref, 0);
	_g_object_unref0 (model);
	_g_variant_unref0 (variant);

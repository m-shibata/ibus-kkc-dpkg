/* setup.c generated by valac 0.22.1, the Vala compiler
...
static void setup_populate_shortcut_treeview (Setup* self, KkcInputMode input_mode) {
	...
	KkcInputMode _tmp36_ = 0;
	KkcUserRule* _tmp37_ = NULL;
	GError * _inner_error_ = NULL;
	g_return_if_fail (self != NULL);
	_tmp0_ = self->priv->preferences;
		...
		for (entry_it = 0; entry_it < _tmp20__length1; entry_it = entry_it + 1) {
			...
			entry = _tmp21_;
			{
				...
				if (_tmp23_ != NULL) {
					...
					KkcKeymapEntry _tmp28_ = {0};
					const gchar* _tmp29_ = NULL;
					KkcKeymapEntry _tmp30_ = {0};
					KkcKeyEvent* _tmp31_ = NULL;
					KkcKeymapEntry _tmp32_ = {0};
					const gchar* _tmp33_ = NULL;
					gchar* _tmp34_ = NULL;
					gchar* _tmp35_ = NULL;
					_tmp24_ = model;
